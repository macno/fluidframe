...
class AdmintranslationlistAction extends AuthAction {
    ...
    function handle() {
            ...
            if(!isset($translationCol['visible']) || $translationCol['visible']) {
                $translationColsJson[] = array(
                        ...
                        'search'=>((isset($translationCol['selectable'])&&($translationCol['selectable'])) ?
                                '<select class="form-control input-sm" id="search_'. $translationName .'"><option value=""></option></select>' :
                                '<input class="form-control input-sm" type="text" id="search_'. $translationName .'">')
                );
            }
        }
        ...
        $this->renderOptions['langs'] = array_keys(common_config('site','langs'));
    ...
    function getJavascripts(){
        return array(
            ...
            "/bower_components/markitup/markitup/sets/html/set.js",
                "/javascripts/admintranslation.js",
        );
    }
